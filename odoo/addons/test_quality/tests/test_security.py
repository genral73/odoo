...
class TestIrModelAccess(TransactionCase):
    ...
    def test_useless_accesses_nice_display(self):
        """Finds and logs useless ir.model.access.
        ...
        for model in models:
            ...
            for rule in rules_to_check:
                implying_rule = rule._is_implied_by(main_public_rules) or rule._is_implied_by(
    ...
    # TODO constraint s.t. a group implied_group shouldn't be already in its transitive implieds.
    ...
    # VFE TODO migration script ensuring for all groups the same abilities for each model ?
