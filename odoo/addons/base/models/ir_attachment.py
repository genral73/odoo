...
class IrAttachment(models.Model):
    ...
    def _inverse_datas(self):
        self._set_attachment_data(lambda attach: base64.b64decode(attach.datas) if attach.datas else b'')
    ...
    def create(self, vals_list):
        ...
        for values in vals_list:
            ...
            if 'datas' in values:
                ...
                values.update(self._get_datas_related_values(base64.b64decode(data) if data else b'', values['mimetype']))
