    ...
    *   :class:`AbstractModel` for abstract super classes meant to be shared by
    ...
    def _auto_init(self):
        ...
        if self._auto:
            if must_create_table:
                def make_type(field):
                    type_ = field.column_type[1]
                    return (type_ + " NOT NULL") if field.required else type_
    ...
    def _setup_base(self):
        ...
        if cls0 and cls0._model_cache_key == cls._model_cache_key:
            ...
            for name in set(cls._fields).difference(cls0._proper_fields):
                delattr(cls, name)
            ...
            if cls0 is cls:
                ...
                cls._proper_fields = list(cls._fields)
