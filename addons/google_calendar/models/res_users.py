...
class User(models.Model):
    ...
    google_calendar_rtoken = fields.Char('Refresh Token', copy=False, groups="base.group_erp_manager")
    google_calendar_token = fields.Char('User token', copy=False, groups="base.group_erp_manager")
