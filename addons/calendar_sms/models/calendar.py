            ...
            if event.recurrency:
                ...
                for event_start in event._get_recurrent_date_by_event():
                    ...
                    for alert in last_found:
                        event.browse(alert['event_id'])._do_sms_reminder(alert)
                        found = True
