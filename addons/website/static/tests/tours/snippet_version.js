...
tour.register("snippet_version", {
    ...
    extra_trigger: 'we-customizeblock-options:contains(Carousel) .snippet-option-VersionControl',
    trigger: '#wrap.o_editable .s_text_image',
}, {
    content: "Got to s_share slide",
    extra_trigger: 'we-customizeblock-options:contains(Text - Image) .snippet-option-VersionControl',
    ...
    extra_trigger: 'we-customizeblock-options:contains(Share) .snippet-option-VersionControl',
    trigger: 'body',
}]);
});
