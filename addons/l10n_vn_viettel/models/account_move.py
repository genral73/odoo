...
class AccountMove(models.Model):
    ...
    def action_export_einvoice(self, is_draft):
        ...
        if self.payment_journal_id.type not in ("bank", "cash"):
            raise UserError(_('The payment journal type should be Bank or Cash'))

        payment_method_name = self.payment_journal_id.type == "bank" and "CK" or "TM"
    ...
    def _l10n_vn_export_to_viettel(self, inv_vals, inv_lines_vals, is_draft=True):
        ...
        for line in inv_lines_vals:
            invoice_line = {
                "lineNumber": line.get(inv_line_fields_mapping['lineNumber']),
                "itemCode": line.get(inv_line_fields_mapping['itemCode']),
                "itemName": line.get(inv_line_fields_mapping['itemName']),
                "unitName": line.get(inv_line_fields_mapping['unitName']),
                "unitPrice": line.get(inv_line_fields_mapping['unitPrice']),
                "quantity": line.get(inv_line_fields_mapping['quantity']),
                "itemTotalAmountWithoutTax": line.get(inv_line_fields_mapping['itemTotalAmountWithoutTax']),
                "taxPercentage": line.get(inv_line_fields_mapping['taxPercentage']),
                "taxAmount": line.get(inv_line_fields_mapping['taxAmount']),
            }
        ...
        invoice = {
            ...
            "buyerInfo": {
                "buyerName": "",
                "buyerLegalName": inv_vals.get(inv_fields_mapping['buyerLegalName']),
                "buyerTaxCode": inv_vals.get(inv_fields_mapping['buyerTaxCode']),
                "buyerAddressLine": inv_vals.get(inv_fields_mapping['buyerAddressLine']),
                "buyerEmail": inv_vals.get(inv_fields_mapping['buyerEmail'])
            },
            "sellerInfo": {
                "sellerLegalName": inv_vals.get(inv_fields_mapping['sellerLegalName']),
                "sellerTaxCode": inv_vals.get(inv_fields_mapping['sellerTaxCode']),
                "sellerAddressLine": inv_vals.get(inv_fields_mapping['sellerAddressLine']),
                "sellerPhoneNumber": inv_vals.get(inv_fields_mapping['sellerPhoneNumber']),
                "sellerWebsite": inv_vals.get(inv_fields_mapping['sellerWebsite']),
                "sellerBankAccount": inv_vals.get(inv_fields_mapping['sellerBankAccount']),
                "sellerBankName": inv_vals.get(inv_fields_mapping['sellerBankName']),
            },
            "payments": [
                {
                    "paymentMethodName": inv_vals.get(inv_fields_mapping['paymentMethodName']),
                }
            ],
            "itemInfo": inv_lines,
            "summarizeInfo": {
                "sumOfTotalLineAmountWithoutTax": inv_vals.get(inv_fields_mapping['sumOfTotalLineAmountWithoutTax']),
                "totalAmountWithoutTax": inv_vals.get(inv_fields_mapping['totalAmountWithoutTax']),
                "totalTaxAmount": inv_vals.get(inv_fields_mapping['totalTaxAmount']),
                "totalAmountWithTax": inv_vals.get(inv_fields_mapping['totalAmountWithTax']),
                "totalAmountWithTaxInWords": inv_vals.get(inv_fields_mapping['totalAmountWithTaxInWords']),
                "discountAmount": 0.0,
            },
            "taxBreakdowns": [
                {
                    "taxPercentage": item.get(inv_line_fields_mapping['taxPercentage']),
                    "taxableAmount": item.get(inv_line_fields_mapping['taxableAmount']),
                    "taxAmount": item.get(inv_line_fields_mapping['taxAmount']),
