...
class AccountMove(models.Model):
    ...
    def _compute_need_kode_transaksi(self):
        for move in self:
            move.l10n_id_need_kode_transaksi = move.partner_id.l10n_id_pkp and not move.l10n_id_efaktur_id and move.type == 'out_invoice'
    ...
    def _generate_efaktur(self, delimiter):
        output_head = self.filtered(lambda x: x.l10n_id_kode_transaksi)._generate_efaktur_invoice(delimiter)
