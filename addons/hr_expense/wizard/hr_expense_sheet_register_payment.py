...
class HrExpenseSheetRegisterPaymentWizard(models.TransientModel):
    ...
    payment_method_id = fields.Many2one('account.payment.method', compute='_compute_payment_method_id', store=True, readonly=False, string='Payment Type', required=True, domain="""[
    ...
    def _compute_partner_bank_account_id(self):
        for wizard in self:
            ...
            elif wizard.partner_id and len(wizard.partner_id.bank_ids) > 0:
                wizard.partner_bank_account_id = wizard.partner_id.bank_ids[0]
            else:
                wizard.partner_bank_account_id = False
