...
class HrExpense(models.Model):
    ...
    accounting_date = fields.Date(string="Accounting Date", compute='_compute_accounting_date', store=True, groups='account.group_account_invoice,account.group_account_readonly')
    ...
    @api.depends('sheet_id', 'sheet_id.accounting_date')
    def _compute_accounting_date(self):
        for expense in self:
            if expense.sheet_id:
                expense.accounting_date = expense.sheet_id.accounting_date
            else:
                expense.accounting_date = False
