...
class AccountInvoiceReport(models.Model):
    ...
    def read_group(self, domain, fields, groupby, offset=0, limit=None, orderby=False, lazy=True):
        ...
        result = super(AccountInvoiceReport, self).read_group(domain, fields, set(groupby) | set(['company_currency_id']), offset, limit, orderby, False)
        for res in result:
            if self.env.company.currency_id.id != res['company_currency_id'][0]:
                for field in set(['price_average', 'price_subtotal']) & set(res):
