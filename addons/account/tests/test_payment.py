...
class TestPayment(AccountTestCommon):
    ...
    def test_full_payment_process(self):
        ...
        self.assertEqual(payment.state, 'posted')
        self.assertTrue(inv_1.payment_state in ('in_payment', 'paid'), "Invoice should be paid")
        ...
        self.assertRecordValues(payment.move_line_ids.sorted('credit'), [
            {'account_id': self.bank_journal_euro.payment_debit_account_id.id, 'debit': 300.0, 'credit': 0.0, 'amount_currency': 0, 'currency_id': False},
    ...
    def test_internal_transfer_journal_usd_journal_eur(self):
        ...
        self.assertRecordValues(payment.move_line_ids, [
            ...
            {'account_id': self.bank_journal_usd.payment_credit_account_id.id, 'debit': 0.0, 'credit': 32.70, 'amount_currency': -50, 'currency_id': self.currency_usd_id},
            {'account_id': self.transfer_account.id, 'debit': 0.0, 'credit': 32.70, 'amount_currency': -50, 'currency_id': self.currency_usd_id},
            {'account_id': self.bank_journal_euro.payment_debit_account_id.id, 'debit': 32.70, 'credit': 0.0, 'amount_currency': 50, 'currency_id': self.currency_usd_id},
        ])
    ...
    def test_payment_chf_journal_usd(self):
        ...
        self.assertRecordValues(payment.move_line_ids, [
            ...
            {'account_id': self.bank_journal_usd.payment_credit_account_id.id, 'debit': 0.0, 'credit': 38.21, 'amount_currency': -58.42, 'currency_id': self.currency_usd_id},
        ])
    ...
    def test_payment_and_writeoff_in_other_currency_1(self):
        ...
        self.assertRecordValues(payment.move_line_ids, [
            ...
            {'account_id': self.bank_journal_euro.payment_debit_account_id.id, 'debit': 16.35, 'credit': 0.0, 'amount_currency': 25.0, 'currency_id': self.currency_usd_id},
        ...
        self.assertRecordValues(payment.move_line_ids, [
            ...
            {'account_id': self.bank_journal_euro.payment_credit_account_id.id, 'debit': 0.0, 'credit': 16.35, 'amount_currency': -25.0, 'currency_id': self.currency_usd_id},
    ...
    def test_payment_and_writeoff_out_refund(self):
        ...
        self.assertRecordValues(payment.move_line_ids, [
            ...
            {'account_id': self.bank_journal_euro.payment_credit_account_id.id, 'debit': 0.0, 'credit': 90.0, 'amount_currency': 0.0, 'currency_id': False},
    ...
    def test_payment_and_writeoff_in_other_currency_3(self):
        ...
        self.assertRecordValues(payment.move_line_ids, [
            ...
            {'account_id': self.bank_journal_euro.payment_debit_account_id.id, 'debit': 253116.0, 'credit': 0.0, 'amount_currency': 267.0, 'currency_id': self.currency_usd_id},
