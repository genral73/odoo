...
class AccountAnalyticLine(models.Model):
    ...
    def _compute_display_timer(self):
        ...
        for analytic_line in self:
            if self.env['uom.uom']._get_uom_by_config_parameter('hr_timesheet.timesheet_encode_uom_id') != uom_hour:
                analytic_line.display_timer = False
            else:
                analytic_line.display_timer = analytic_line.project_id.allow_timesheet_timer and analytic_line.user_id.id == self.env.uid
