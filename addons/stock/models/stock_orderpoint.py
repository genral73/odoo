...
class StockWarehouseOrderpoint(models.Model):
    ...
    trigger = fields.Selection([
        ('auto', 'Auto'), ('manual', 'Manual')], string='Trigger', default='auto', required=1)
    ...
    def _compute_lead_days(self):
        for orderpoint in self:
            ...
            orderpoint.json_lead_days_popover = dumps({
                ...
                'virtual': orderpoint.create_uid.id == SUPERUSER_ID,
            })
    ...
    def _onchange_product_min_max_qty(self):
        if self.product_id and self.location_id:
    ...
    def action_replenish(self):
        ...
        self._compute_qty()
        self.filtered(lambda o: o.qty_to_order <= 0.0).write({'active': False})
    ...
    def _get_orderpoint_action(self):
        ...
        to_remove = orderpoints.filtered(lambda o: o.create_uid.id == SUPERUSER_ID and o.qty_to_order <= 0.0)
        to_remove.unlink()
        ...
        dummy, qty_by_product_wh = self.env['stock.warehouse.orderpoint']._get_quantity_in_progress(product_ids, warehouse_ids=warehouse_ids)
        key_to_remove = []
