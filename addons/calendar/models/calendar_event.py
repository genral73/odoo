...
class Meeting(models.Model):
    ...
    stop = fields.Datetime('Stop', required=True, tracking=True, default=fields.Date.today, compute='_compute_stop', inverse='_inverse_stop', store=True,
    ...
    attendee_ids = fields.One2many(
        'calendar.attendee', 'event_id', 'Participant', ondelete='cascade')
