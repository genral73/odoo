...
QUnit.module('LunchListView', {
    ...
    QUnit.module('LunchWidget', function () {
        ...
        QUnit.test('select a product via checkbox', async function (assert) {
            // same test as above but the wizard should not open if a click is done on a checkbox
            assert.expect(0);
            ...
            await testUtils.dom.click(list.$('.o_data_row > td.o_list_record_selector'));
