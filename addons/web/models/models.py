...
class Base(models.AbstractModel):
    ...
    def search_panel_select_range(self, field_name, **kwargs):
        ...
        return {
            ...
            'values': Comodel.with_context(hierarchical_naming=False).search_read([], fields, order=kwargs.get('order', None)),
        }
    ...
    def search_panel_select_multi_range(self, field_name, **kwargs):
        ...
        if field.type == 'many2one':
            ...
            records = Comodel.search_read(comodel_domain, field_names, order=order)
            ...
            counters = {}
            if not disable_counters:
                groups = self.read_group(model_domain, [field_name], [field_name], orderby=order)
                counters = {
