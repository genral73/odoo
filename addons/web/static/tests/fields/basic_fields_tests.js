...
QUnit.module('basic_fields', {
    ...
    QUnit.test('use toggle_button in list view', async function (assert) {
        ...
        assert.containsN(list, 'button i.fas.fa-circle.o_toggle_button_success', 4,
            "should have 4 green buttons");
        assert.containsOnce(list, 'button i.fas.fa-circle.text-muted',
        ...
        assert.containsN(list, 'button i.fas.fa-circle.o_toggle_button_success', 3,
    ...
    QUnit.test('datetime field in form view', async function (assert) {
        ...
        await testUtils.dom.click($('.bootstrap-datetimepicker-widget .far.fa-clock'));
    ...
    QUnit.test('priority widget in editable list view', async function (assert) {
        ...
        await testUtils.dom.click(list.$('.o_priority a.o_priority_star.fas.fa-star').first());
