odoo.define("web.class_patcher_tests", function (require) {
    "use strict";
    ...
    QUnit.module('core', {}, function () {
        ...
        QUnit.module('class patcher', {}, function () {

            QUnit.test('basic use', function (assert) {
                assert.expect(4);

                const A = makePatchable(
                    class {
                        constructor() {
            ...
            QUnit.test('class fields', function (assert) {
                ...
                const PatchableA = makePatchable(A);
            ...
            QUnit.module('inheritance', {}, function () {
                ...
                QUnit.test('class fields', function (assert) {
                    ...
                    const PatchableB = makePatchable(B);
