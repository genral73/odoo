odoo.define('web.SearchBar', function (require) {
     ...
     * 1) Display the current search facets (@see SearchFacet Component)
    ...
    class SearchBar extends Component {
        ...
        _onFacetRemoved(ev) {
            ...
            this.model.dispatch('deactivateGroup', facet.group.id);
        }
                ...
                case 'Backspace':
                    if (!this.state.inputValue.length) {
                        ...
                        if (facets.length) {
                            ...
                            this.model.dispatch('deactivateGroup', lastFacetGroupId);
                        }
                    }
                    break;
                case 'Enter':
