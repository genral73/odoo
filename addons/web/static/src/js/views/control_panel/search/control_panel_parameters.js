odoo.define('web.controlPanelParameters', function (require) {
    ...
    const INTERVAL_OPTIONS = {
        year: { description: _lt('Year'), optionId: 'year', groupNumber: 1 },
        quarter: { description: _lt('Quarter'), optionId: 'quarter', groupNumber: 1 },
        month: { description: _lt('Month'), optionId: 'month', groupNumber: 1 },
        week: { description: _lt('Week'), optionId: 'week', groupNumber: 1 },
        day: { description: _lt('Day'), optionId: 'day', groupNumber: 1 },
    };
