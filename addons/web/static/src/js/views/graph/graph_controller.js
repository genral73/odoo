...
var GraphController = AbstractController.extend({
    ...
    init: function (parent, model, renderer, params) {
        ...
        this.noButtons = params.noButtons;
    ...
    async willStart() {
        ...
        if (!this.noButtons) {
            ...
            promises.push(this.measureMenu.mount(fragment));
            if (this.isEmbedded) {
                ...
                promises.push(this.groupByMenu.mount(fragment));
            }
        }
