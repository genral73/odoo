odoo.define('web.searchUtils', function (require) {
    ...
    const QUARTER_OPTIONS = {
        fourth_quarter: { id: 'fourth_quarter', groupNumber: 1, description: "Q4", addParam: {}, setParam: { quarter: 4 }, granularity: 'quarter' },
        third_quarter: { id: 'third_quarter', groupNumber: 1, description: "Q3", addParam: {}, setParam: { quarter: 3 }, granularity: 'quarter' },
        second_quarter: { id: 'second_quarter', groupNumber: 1, description: "Q2", addParam: {}, setParam: { quarter: 2 }, granularity: 'quarter' },
        first_quarter: { id: 'first_quarter', groupNumber: 1, description: "Q1", addParam: {}, setParam: { quarter: 1 }, granularity: 'quarter' },
    };
    const YEAR_OPTIONS = {
    ...
    const INTERVAL_OPTIONS = {
        year: { description: 'Year', id: 'year', groupNumber: 1 },
        quarter: { description: 'Quarter', id: 'quarter', groupNumber: 1 },
        month: { description: 'Month', id: 'month', groupNumber: 1 },
        week: { description: 'Week', id: 'week', groupNumber: 1 },
        day: { description: 'Day', id: 'day', groupNumber: 1 }
    };
